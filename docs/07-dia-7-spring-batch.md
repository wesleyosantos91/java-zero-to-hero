# ~~Dia 7 — Spring Batch~~ — Arquivo Legado
...
**Módulo 06 — Spring Batch** → [`modulo-06-spring-batch/01-introducao-spring-batch.md`](modulo-06-spring-batch/01-introducao-spring-batch.md)
